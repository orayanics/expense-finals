          ...
          <main className="how-accordion">
            ...
            <Accordion className="custom-accordion">
              <Accordion.Item eventKey="0">
                ...
                <Accordion.Body>
                  Users may need to complete their profile by adding their
                  Google account.
                </Accordion.Body>
              </Accordion.Item>
            </Accordion>
            ...
            <Accordion className="custom-accordion">
              <Accordion.Item eventKey="2">
                ...
                <Accordion.Body>
                  Many expense websites offer budgeting tools that allow users
                  to set spending limits for different categories.
                </Accordion.Body>
              </Accordion.Item>
            </Accordion>
            ...
            <Accordion className="custom-accordion">
              <Accordion.Item eventKey="3">
                ...
                <Accordion.Body>
                  Users can generate reports to analyze their spending habits
